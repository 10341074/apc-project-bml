...
class CSR : public Sparse{
	...
	CSR(std::vector<Car> * p);
	CSR(std::unique_ptr< std::vector<Car> > & p);
	CSR(std::size_t nr, std::size_t nc, std::size_t nz, std::vector<Car> * p);
	CSR(std::size_t nr, std::size_t nc, std::size_t nz, std::unique_ptr< std::vector<Car> > & p);
